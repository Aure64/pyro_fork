...
export default async ({
  ...
  const [bakingRights, endorsingRights] = <[BakingRightsL, EndorsingRightsL]>(
...
type CheckBlockEndorsingRightsArgs = {
  baker: string;
  endorsementOperations: OperationL[];
  level: number;
  endorsingRights: EndorsingRightsL;
};
