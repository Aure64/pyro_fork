...
const _011_PtHangz2$operation$alpha$operation_contents_and_result = {
  oneOf: [
    {
      title: "Endorsement",
      type: "object",
      properties: {
        ...
        metadata: {
          ...
          required: ["slots", "delegate", "balance_updates"],
          additionalProperties: false,
        },
      },
      required: ["metadata", "level", "kind"],
      additionalProperties: false,
    },
    {
    ...
    },
    {
      ...
      required: ["metadata", "slot", "endorsement", "kind"],
      additionalProperties: false,
    },
    {
      ...
      required: ["metadata", "slot", "op2", "op1", "kind"],
      additionalProperties: false,
    },
    {
        ...
        metadata: {
          ...
          properties: {
            balance_updates:
              _011_PtHangz2$operation_metadata$alpha$balance_updates,
            operation_result:
              _011_PtHangz2$operation$alpha$operation_result$reveal,
            internal_operation_results: {
              type: "array",
              items: _011_PtHangz2$operation$alpha$internal_operation_result,
            },
          },
        ...
        metadata: {
          ...
          properties: {
            balance_updates:
              _011_PtHangz2$operation_metadata$alpha$balance_updates,
            operation_result:
              _011_PtHangz2$operation$alpha$operation_result$transaction,
            internal_operation_results: {
              type: "array",
              items: _011_PtHangz2$operation$alpha$internal_operation_result,
            },
        ...
        metadata: {
          ...
          properties: {
            balance_updates:
              _011_PtHangz2$operation_metadata$alpha$balance_updates,
            operation_result:
              _011_PtHangz2$operation$alpha$operation_result$origination,
            internal_operation_results: {
              type: "array",
              items: _011_PtHangz2$operation$alpha$internal_operation_result,
            },
        ...
        metadata: {
          ...
          properties: {
            balance_updates:
              _011_PtHangz2$operation_metadata$alpha$balance_updates,
            operation_result:
              _011_PtHangz2$operation$alpha$operation_result$delegation,
            internal_operation_results: {
              type: "array",
              items: _011_PtHangz2$operation$alpha$internal_operation_result,
            },
...
export default _011_PtHangz2$operation$alpha$operation_contents_and_result;
