...
const _011_PtHangz2$operation$alpha$successful_manager_operation_result = {
  oneOf: [
    {
      title: "reveal",
      type: "object",
...
export default _011_PtHangz2$operation$alpha$successful_manager_operation_result;
