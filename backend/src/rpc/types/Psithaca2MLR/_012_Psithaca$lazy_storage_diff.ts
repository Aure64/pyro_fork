...
const _012_Psithaca$lazy_storage_diff = {
  type: "array",
  items: {
    oneOf: [
      {
            ...
            oneOf: [
              ...
              },
              {
                ...
                properties: {
                  ...
                  source: _012_Psithaca$big_map_id,
                  updates: {
                    type: "array",
                    items: {
                      type: "object",
      ...
      },
      {
        ...
        properties: {
          ...
          id: _012_Psithaca$sapling_state_id,
          diff: {
            oneOf: [
              {
                title: "update",
              ...
              },
              {
                ...
                properties: {
                  action: { type: "string", enum: ["copy"] },
                  source: _012_Psithaca$sapling_state_id,
                  updates: {
                    type: "object",
                    properties: {
                      commitments_and_ciphertexts: {
...
export default _012_Psithaca$lazy_storage_diff;
