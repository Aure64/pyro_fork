...
const _012_Psithaca$operation$alpha$operation_result$set_deposits_limit = {
  oneOf: [
    {
      title: "Applied",
      type: "object",
...
export default _012_Psithaca$operation$alpha$operation_result$set_deposits_limit;
