...
export default async ({
  ...
  const [bakingRights, endorsingRights] = <[BakingRightsN, EndorsingRightsN]>(
...
type CheckBlockEndorsingRightsArgs = {
  baker: string;
  endorsementOperations: OperationN[];
  level: number;
  endorsingRights: EndorsingRightsN;
};
