...
export default async ({
  ...
  const [bakingRights, endorsingRights] = <[BakingRightsJ, EndorsingRightsJ]>(
...
type CheckBlockEndorsingRightsArgs = {
  baker: string;
  endorsementOperations: OperationJ[];
  level: number;
  endorsingRights: EndorsingRightsJ;
};
